        ...
        <div class="info-group">
          ...
          <div class="control-section">
            ...
            <template v-if="musicStore.playSong.type !== 'radio' && !statusStore.personalFmMode">
              <div class="mode-btn" @click.stop="player.togglePlayMode(false)">
                <SvgIcon
                  :name="statusStore.playModeIcon"
                  :size="24"
                />
              </div>
            </template>
...
const timeDisplay = computed(() => [
  msToTime(player.getSeek() * 1000),
  msToTime(musicStore.playSong.duration || 0)
]);
